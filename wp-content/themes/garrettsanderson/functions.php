...
function load_styles_scripts()
{
    ...
    // Load Vimeo API
    wp_enqueue_script('vimeo-player', get_template_directory_uri() . '/includes/js/contrib/player.vimeo.js', array(), '0.5.1', true);

    // Load Global JS
    wp_enqueue_script('js', get_template_directory_uri() . '/includes/js/min/app.js', array('jQuery'), false, true);
