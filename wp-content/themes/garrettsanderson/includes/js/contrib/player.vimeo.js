/*! @vimeo/player v2.4.0 | (c) 2018 Vimeo | MIT License | https://github.com/vimeo/player.js */ !(function (e, t) {
    ...
    function h(e) {
        ...
        return new Promise(function (n, o) {
            ...
            u.open("GET", i, !0),
                (u.onload = function () {
                    if (404 === u.status)
                        return void o(new Error("“" + e + "” was not found."));
                    if (403 === u.status)
                        return void o(new Error("“" + e + "” is not embeddable."));
                    try {
                        ...
                        try {
                            !1 === t ?
                                ...
                                ((o = !0 === t ? e.msg : t.call(void 0, e.msg)),
                                    ...
                                    (i = n(o)) ? i.call(o, r.resolve, r.reject) : r.resolve(o));
                        } catch (e) {
                            r.reject(e);
                        }
                    }
            ...
            function Player(e) {
                ...
                if (
                    (m(this, Player),
                        ...
                        "string" == typeof e &&
                        (e = document.getElementById(e)), !t(e))
                )
                    throw new TypeError(
                ...
                var e =
                    ...
                    t = function (t) {
                        if (r(t.origin) && t.data && "spacechange" === t.data.event)
                            for (
                                var n = e.querySelectorAll("iframe"), o = 0; o < n.length; o++
                            )
